...
loss_con = pd.read_csv('concrete_valid_hist.csv').to_numpy()
loss_enr = pd.read_csv('energy_valid_hist.csv').to_numpy()
loss_yat = pd.read_csv('yacht_valid_hist.csv').to_numpy()
param_con = pd.read_csv('concrete_params_hist.csv').to_numpy()
param_enr = pd.read_csv('energy_params_hist.csv').to_numpy()
param_yat = pd.read_csv('yacht_params_hist.csv').to_numpy()
