...
def plot4_toy(flow_ficnn, flow_picnn, x, z, device, swap, tol, sPath, sTitle="", hidevals=True):
    ...
    if swap is False:
        x1_generated, _ = flow_ficnn.g1(latent1, tol=tol)
        x1_generated = x1_generated.detach()
        x2_generated, _ = flow_picnn.g2(latent2, x1_generated, tol=tol)
        x2_generated = x2_generated.detach()
    else:
        x2_generated, _ = flow_ficnn.g1(latent2, tol=tol)
        x2_generated = x2_generated.detach()
        x1_generated, _ = flow_picnn.g2(latent1, x2_generated, tol=tol)
        x1_generated = x1_generated.detach()
