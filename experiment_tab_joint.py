...
loss_pk = pd.read_csv('parkinson_valid_hist.csv').to_numpy()
loss_rd = pd.read_csv('rd_wine_valid_hist.csv').to_numpy()
loss_wt = pd.read_csv('wt_wine_valid_hist.csv').to_numpy()
param_pk = pd.read_csv('parkinson_params_hist.csv').to_numpy()
param_rd = pd.read_csv('rd_wine_params_hist.csv').to_numpy()
param_wt = pd.read_csv('wt_wine_params_hist.csv').to_numpy()
